...
public final class Constants {
    ...
    public static final String GLYPH_CALL_SUB_CUSTOM_RINGTONE_URI = "glyph_settings_call_sub_custom_ringtone_uri";
    public static final String GLYPH_CALL_CUSTOM_VALUE = "__custom__";
